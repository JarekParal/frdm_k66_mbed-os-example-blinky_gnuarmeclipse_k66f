...
#define MBED_CONF_PLATFORM_CRASH_CAPTURE_ENABLED                              1                                                                                                // set by library:platform[K66F]
...
#define MBED_CONF_PLATFORM_FATAL_ERROR_AUTO_REBOOT_ENABLED                    1                                                                                                // set by library:platform[K66F]
...
#define MBED_CONF_SD_SPI_CLK                                                  PTE2                                                                                             // set by library:sd[K66F]
#define MBED_CONF_SD_SPI_CS                                                   PTE4                                                                                             // set by library:sd[K66F]
#define MBED_CONF_SD_SPI_MISO                                                 PTE1                                                                                             // set by library:sd[K66F]
#define MBED_CONF_SD_SPI_MOSI                                                 PTE3                                                                                             // set by library:sd[K66F]
#define MBED_CONF_SD_TEST_BUFFER                                              8192                                                                                             // set by library:sd
#define MBED_CONF_SPM_IPC_MAX_NUM_OF_CHANNELS                                 10                                                                                               // set by library:spm
#define MBED_CONF_SPM_IPC_MAX_NUM_OF_MESSAGES                                 10                                                                                               // set by library:spm
...
#define MBED_CONF_STORAGE_STORAGE_TYPE                                        TDB_INTERNAL                                                                                     // set by library:storage[K66F]
